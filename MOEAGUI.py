...
st.write("### EA Hyperparameter Setting")
...
if __name__ == '__main__':
    ...
    # output(res, problemname, dimension, outputfile)  # plot function of the final result


    plt.figure(figsize=(10, 6), dpi=300)
    plt.scatter(res.F[:, 0], res.F[:, 1])  # Replace with your actual data
